  ...
  return (
    <div className="p-6 md:p-8">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-black text-dash-text">Referral Links</h1>
      ...
      {showForm && (
        <form onSubmit={createLink} className="mb-6 rounded-xl border border-purple-100 bg-purple-50 p-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-xs font-bold text-dash-body">Label</label>
            ...
            <div>
              <label className="mb-1 block text-xs font-bold text-dash-body">Destination URL <span className="text-red-500">*</span></label>
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <p className="font-bold text-dash-text">{link.label || link.ref_code}</p>
                    ...
                    <p className="mt-1 truncate text-xs text-dash-muted">{link.destination_url}</p>
