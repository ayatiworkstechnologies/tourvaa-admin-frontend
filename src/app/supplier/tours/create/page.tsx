        ...
        <div className="rounded-xl border border-dash-border bg-white p-6 shadow-sm">
          ...
          {step === 0 && (
            <div className="space-y-4">
              <h2 className="mb-5 text-base font-black text-dash-text">
                Basic Details
              </h2>
              <div>
          ...
          {step === 2 && (
            <div>
              <div className="mb-5 flex items-center justify-between">
                <h2 className="text-base font-black text-dash-text">
                  Pricing Slabs
                </h2>
                <button
                  type="button"
              ...
              <div className="space-y-4">
                {slabs.map((slab, i) => (
                  <div
                    key={i}
                    className="rounded-xl border border-dash-border p-4"
                  >
                    <div className="mb-3 flex items-center justify-between">
                      <p className="text-xs font-bold text-dash-muted">
                        Slab {i + 1}
                      </p>
                      {slabs.length > 1 && (
                        <button
                          ...
                          title="Remove slab"
                          className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg text-red-400 hover:bg-red-50"
                        >
                          <Trash2 size={13} />
                        </button>
                      )}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="rounded-xl border border-dash-border p-4">
                  <p className="mb-3 text-xs font-bold uppercase text-dash-muted">
                    Basic Details
                  </p>
                  <div className="grid gap-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-dash-muted">Title</span>
                    ...
                    {subtitle && (
                      <div className="flex justify-between">
                        <span className="text-dash-muted">Subtitle</span>
                        <span className="font-semibold text-dash-text">
                          {subtitle}
                        </span>
                      </div>
                    ...
                    <div className="flex justify-between">
                      <span className="text-dash-muted">Days</span>
                      <span className="font-semibold text-dash-text">
                        {numberOfDays}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-dash-muted">Country</span>
                      <span className="font-semibold text-dash-text">
