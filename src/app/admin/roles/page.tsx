    ...
    <ModuleWrapper title="Roles" requiredPermission="roles.view">
      <div className="rounded-3xl border border-dash-border/60 bg-white p-8 shadow-[0_2px_12px_rgb(0,0,0,0.03)]">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-[28px] font-black tracking-tight text-dash-text">Roles</h2>
          ...
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
            <input
              ...
              className="w-full rounded-xl border border-dash-border/80 bg-dash-bg px-4 py-3 text-sm font-medium outline-none focus:bg-white focus:border-dash-brand focus:ring-4 focus:ring-dash-brand/10 transition-all sm:w-64"
            />
            <button
              type="button"
              onClick={openCreate}
              className="flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-dash-brand px-5 py-3 text-sm font-bold text-white shadow-[0_4px_12px_rgb(67,169,246,0.25)] hover:bg-dash-brand-hover transition-all hover:-translate-y-0.5"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-lg rounded-3xl bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            <div className="mb-6 flex items-center justify-between">
              <h3 className="text-xl font-black tracking-tight text-dash-text">
                {editingRole ? "Edit Role" : "Add Role"}
              </h3>
              <button
                onClick={closeForm}
                className="rounded-xl p-2 text-dash-muted hover:bg-dash-bg transition-colors"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <form onSubmit={submitRole} className="space-y-4">
              <label className="block">
                  <span className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-dash-muted">
                    Role Name
                  </span>
                  <input
                    value={form.name}
                    ...
                    className="w-full rounded-xl border border-dash-border/80 bg-dash-bg px-4 py-3 text-sm font-medium outline-none focus:bg-white focus:border-dash-brand focus:ring-4 focus:ring-dash-brand/10 transition-all"
                    required
                  />
                </label>
              ...
              <div className="flex justify-end gap-3 pt-6">
                <button
                  type="button"
                  onClick={closeForm}
                  className="rounded-xl border border-dash-border/80 bg-white px-5 py-2.5 text-sm font-bold text-dash-body shadow-sm hover:bg-dash-bg hover:text-dash-text transition-all"
                >
                  Cancel
                </button>
                <button
                  disabled={saving}
                  className="rounded-xl bg-dash-brand px-6 py-2.5 text-sm font-bold text-white shadow-[0_4px_12px_rgb(67,169,246,0.25)] hover:bg-dash-brand-hover transition-all hover:-translate-y-0.5"
                >
                  {saving ? "Saving..." : "Save"}
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="flex max-h-[86vh] w-full max-w-5xl flex-col rounded-xl bg-white p-6 shadow-2xl">
            ...
            <input
              ...
              className="mb-3 w-full rounded-lg border border-[#E6E8F0] px-4 py-2.5 text-sm outline-none focus:border-dash-brand focus:ring-4 focus:ring-dash-brand/10 transition-all"
            />

            <div className="mb-4 flex flex-col gap-3 rounded-lg bg-dash-bg px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="text-xs font-semibold text-dash-brand">
              ...
              <div className="overflow-hidden rounded-xl border border-[#E6E8F0]">
                <div className="overflow-x-auto">
                  <div className="min-w-[900px]">
                    <div className="grid grid-cols-[1.3fr_1fr_1fr_1fr_1fr_2fr_0.8fr] bg-dash-bg px-4 py-3 text-[11px] font-bold uppercase tracking-wider text-gray-500">
                      <span>Module</span>
            ...
            <div className="mt-5 flex justify-end gap-3 border-t border-[#E6E8F0] pt-4">
              ...
              <button
                ...
                disabled={saving}
                className="flex items-center gap-2 rounded-md bg-dash-brand px-5 py-2 text-sm font-semibold text-white hover:bg-dash-brand-hover"
              >
                <Save size={15} />
