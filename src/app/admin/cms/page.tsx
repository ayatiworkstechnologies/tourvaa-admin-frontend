    ...
    <div className="space-y-4">
      ...
      {showForm && (
        <div className="rounded-xl border border-dash-border bg-white p-6">
          <h3 className="mb-4 text-base font-bold text-dash-text">{editingItem ? `Edit ${tab.label}` : `New ${tab.label}`}</h3>
    ...
    <ModuleWrapper title="CMS Management" requiredPermission="settings.view">
      <div className="space-y-5">
        ...
        <section className="flex items-center justify-between rounded-xl border border-dash-border bg-white p-6">
          <div>
            <h2 className="text-2xl font-bold text-dash-text">CMS Management</h2>
            <p className="mt-1 text-sm text-dash-muted">Manage all website content from one place.</p>
          </div>
