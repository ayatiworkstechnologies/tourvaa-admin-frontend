      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute bottom-3 right-3 text-gray-500 hover:text-dash-brand"
        ...
        <div className="pt-2 text-center">
          <button
            disabled={loading}
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-dash-brand px-12 py-3.5 text-xs font-bold text-white shadow-lg shadow-sky-200 transition hover:bg-dash-brand-hover disabled:cursor-not-allowed disabled:opacity-70"
          >
            <LogIn size={16} />
