...
export default function AgentBookingDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (error || !booking) {
    return (
      <div className="p-6 md:p-8">
        <Link href="/agent/bookings" className="flex items-center gap-2 text-sm font-bold text-dash-muted hover:text-orange-600">
  ...
  return (
    <div className="p-6 md:p-8">
      ...
      {/* Travellers */}
      {travellers.length > 0 && (
        <div className="mt-6 rounded-xl border border-dash-border bg-white p-6 shadow-sm">
