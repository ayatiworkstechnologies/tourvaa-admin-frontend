                    ...
                    return (
                      <div key={field.id} className="rounded-2xl border border-slate-200 p-4">
                        ...
                        <div className="grid gap-3 sm:grid-cols-[1fr_120px]">
                          ...
                          <label className="field-label">Age *<input type="number" min={adult ? 12 : 2} max={adult ? 120 : 11} aria-invalid={Boolean(travellerError?.age)} {...register(`travellers.${index}.age`, { required: "Age is required", validate: (v) => { const age = Number(v); return (adult ? age >= 12 && age <= 120 : age >= 2 && age <= 11) || (adult ? "Age must be 12–120" : "Age must be 2–11"); } })} className={`field ${travellerError?.age ? "border-red-400 ring-2 ring-red-100" : ""}`} /><ErrorText text={travellerError?.age?.message} /></label>
                        </div>
