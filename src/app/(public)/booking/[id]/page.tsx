                    ...
                    return (
                      <div key={field.id} className="rounded-2xl border border-slate-200 p-4">
                        ...
                        <div className="mt-3 grid gap-3 sm:grid-cols-3">
                          ...
                          <Controller control={control} name={`travellers.${index}.date_of_birth`} render={({ field }) => <DatePicker value={field.value} onChange={field.onChange} maxDate={new Date().toISOString().split("T")[0]} label="Date of birth" placeholder="Select date" />} />
                        ...
                        {!isPrimary && (
                          <div className="mt-3 grid gap-3 sm:grid-cols-2">
                            ...
                            <Controller control={control} name={`travellers.${index}.passport_expiry_date`} render={({ field }) => <DatePicker value={field.value} onChange={field.onChange} minDate={new Date().toISOString().split("T")[0]} label="Passport expiry (optional)" placeholder="Select date" />} />
                          </div>
                        )}
                      </div>
                    );
