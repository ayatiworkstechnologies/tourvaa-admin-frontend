...
export const PAGE_METADATA: Record<string, PageDefinition> = {
  ...
  "/help": { title: "Help", description: "Find Tourvaa booking, account, payment, and travel support." },
  "/help-centre": { title: "Help Centre", description: "Find answers and guidance for Tourvaa bookings, payments, accounts, suppliers, agents, and travel support." },
  ...
  "/admin/admin-modules": { title: "Admin Modules", description: "Configure which administration modules are enabled and visible across the Tourvaa console.", index: false },
  ...
  "/admin/affiliates/links": { title: "Affiliate Links", description: "Generate, edit, and manage affiliate referral links across all affiliates and tours.", index: false },
  "/admin/affiliates/links/new": { title: "Generate Affiliate Link", description: "Generate a new trackable referral link for an affiliate.", index: false },
  "/admin/affiliates/links/[id]": { title: "Affiliate Link Details", description: "Review performance and manage settings for an affiliate referral link.", index: false },
  "/admin/affiliates/commission-rules": { title: "Affiliate Commission Rules", description: "Configure commission rates by affiliate, tour, category, or link.", index: false },
  "/admin/affiliates/payouts": { title: "Affiliate Payouts", description: "Review and process affiliate payout requests.", index: false },
  ...
  "/admin/checkout-sessions": { title: "Checkout Sessions", description: "Review in-progress and abandoned Tourvaa checkout sessions across payment gateways.", index: false },
  "/admin/cms": { title: "Content Management", description: "Manage Tourvaa website content and publishing records.", index: false },
  "/admin/cms/[section]": { title: "Content Management", description: "Manage the selected Tourvaa website content section and its publishing settings.", index: false },
  "/admin/email-logs": { title: "Email Logs", description: "Review transactional and operational emails sent by the Tourvaa platform.", index: false },
  ...
  "/affiliate/payouts": { title: "Affiliate Payouts", description: "Request payouts and review payout history and commission payment status.", index: false },
  "/affiliate/payout-methods": { title: "Payout Methods", description: "Manage bank and PayPal payout methods for receiving affiliate commissions.", index: false },
  "/affiliate/wallet": { title: "Affiliate Wallet", description: "Review pending, available, and paid affiliate commission balances.", index: false },
  "/affiliate/support": { title: "Affiliate Support", description: "Chat directly with Tourvaa support about your affiliate account.", index: false },
