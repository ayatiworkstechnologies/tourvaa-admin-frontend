...
export const PAGE_METADATA: Record<string, PageDefinition> = {
  ...
  "/agent/bookings/create": { title: "Create Agent Booking", description: "Select a customer and tour, add travellers, confirm pricing, and collect payment.", index: false },
