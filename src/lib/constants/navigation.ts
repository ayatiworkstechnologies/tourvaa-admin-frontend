...
export const adminNavItems: NavItem[] = [
  ...
  { label: "Countries", module: "countries", href: "/admin/settings/countries", icon: Globe, permissions: ["countries.view", "view-countries", "cities.view", "view-cities", "currencies.view"], section: "Tour Management" },
