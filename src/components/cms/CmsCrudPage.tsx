...
import { CmsRecord, createCms, listCms, updateCms, updateCmsStatus } from "@/lib/api/services/cmsService";
      ...
      <div className="space-y-5">
        ...
        <section className="flex flex-col gap-4 rounded-xl border border-dash-border bg-white p-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-dash-muted">Create, edit, and disable foundational CMS data.</p>
          </div>
