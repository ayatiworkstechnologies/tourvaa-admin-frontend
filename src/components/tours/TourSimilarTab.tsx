...
export default function TourSimilarTab({ tourId }: { tourId: string }) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-dash-text">Similar Tours</h2>

      <div className="rounded-2xl border border-dash-border-soft bg-white p-5 shadow-[0_1px_4px_0_rgb(0,0,0,0.04)]">
        <p className="mb-3 text-sm font-semibold text-dash-body">Add a similar tour</p>
        <div className="flex gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-dash-brand px-4 py-2.5 text-sm font-bold text-white disabled:opacity-60"
          >
      ...
      {items.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-dash-border p-8 text-center text-sm text-dash-subtle">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          {items.map((item) => (
            <div
              key={item.id}
              className="flex items-center justify-between rounded-2xl border border-dash-border-soft bg-white p-4 shadow-[0_1px_4px_0_rgb(0,0,0,0.04)]"
            >
              <span className="inline-flex items-center gap-2 font-semibold text-dash-text">
