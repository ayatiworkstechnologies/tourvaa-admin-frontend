    ...
    <div className="flex flex-wrap gap-2">
      {canReset && (
        <button
          ...
          disabled={saving}
          onClick={onReset}
          className="inline-flex items-center gap-2 rounded-xl border border-dash-border px-4 py-2.5 text-sm font-bold text-dash-text hover:bg-dash-bg disabled:opacity-60"
        >
          <KeyRound size={16} />
          Reset Password
        </button>
