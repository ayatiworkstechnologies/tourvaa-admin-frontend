...
import { ActivityLog, getActivityLogs } from "@/lib/services/activityLogService";
  ...
  return (
    <ModuleWrapper title="Activity Logs" requiredPermission="activity_logs.view">
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-[#121826]">Activity Logs</h1>
          <p className="text-sm text-[#667085]">Audited booking, payment, invoice, and admin actions.</p>
        </div>
