...
function PayNowModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-sm rounded-3xl border border-[#E7EAF0] bg-white p-6 shadow-2xl">
        <div className="mb-5 flex items-center justify-between">
          <div>
            <h3 className="text-lg font-black text-[#121826]">Complete Payment</h3>
            <p className="text-sm text-[#667085]">
              Amount due: <strong className="text-[#121826]">{currency} {amount.toLocaleString()}</strong>
            </p>
          </div>
          <button type="button" onClick={onClose} disabled={!!loading} aria-label="Close payment modal"
            className="rounded-xl p-1.5 text-[#667085] hover:bg-[#F7F9FC] hover:text-[#121826]">
            <X size={18} />
          </button>
        </div>
