...
import { ArrowLeft, Ban, Briefcase, Check, CheckCircle2, Eye, FileText, Percent, Receipt, ShieldHalf, Truck, X, XCircle } from "lucide-react";
        ...
        <div className="space-y-6">
          ...
          {record.markup_type && (
            <div className="rounded-2xl border border-[#E9EDF3] bg-white p-5 shadow-[0_1px_4px_0_rgb(0,0,0,0.04)]">
              <p className="text-xs font-bold uppercase tracking-wide text-[#98A2B3]">Commission / Markup</p>
                      ...
                      <div key={doc.id ?? index} className="rounded-xl border border-[#E7EAF0] p-4">
                        ...
                        <div className="mt-3 flex flex-wrap items-center gap-2">
                          {(doc.file_url || doc.file_path) && (
                            <a href={String(doc.file_url || doc.file_path)} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-lg border border-[#E7EAF0] px-3 py-2 text-xs font-bold text-[#2F9FE9] hover:bg-[#E7F5FF]">
