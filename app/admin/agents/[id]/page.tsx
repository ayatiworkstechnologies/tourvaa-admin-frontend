      ...
      {loading ? (
        ...
        <div className="space-y-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <Link href="/admin/agents" className="inline-flex items-center gap-2 text-sm font-bold text-[#121826] hover:text-[#2F9FE9]">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {canBlock && <button onClick={() => isBlocked ? void run(() => updateReviewRecord("agents", id, { status: "active" }), "Agent unblocked.") : setModal("block")} className="inline-flex items-center gap-2 rounded-xl border border-[#E7EAF0] px-4 py-2.5 text-sm font-bold text-[#121826] hover:bg-[#F7F9FC]"><Ban size={16} /> {isBlocked ? "Unblock" : "Block"}</button>}
              {canCommercial && <button onClick={() => setModal("commercial")} className="inline-flex items-center gap-2 rounded-xl border border-[#E7EAF0] px-4 py-2.5 text-sm font-bold text-[#121826] hover:bg-[#F7F9FC]"><Percent size={16} /> Discount</button>}
            </div>
          </div>
        ...
        <section className="rounded-xl border border-[#E7EAF0] bg-white p-10 text-center text-[#667085]">Agent not found.</section>
      )}
    </ModuleWrapper>
  );
}
