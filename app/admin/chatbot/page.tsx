  ...
  const columns: DataTableColumn<FAQ>[] = [
    {
      key: "no",
      header: "#",
      className: "w-14 font-bold text-[#667085]",
      ...
      <DashboardLayout title="Chatbot FAQ" menus={dashboard.menus} user={dashboard.user}>
        <div className="space-y-6">
          <section className="rounded-2xl border border-[#E7EAF0] bg-white p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#667085] mt-0.5">
                    Manage AI knowledge base â€” these Q&amp;As are injected into the AI assistant&apos;s context.
                  </p>
                </div>
              </div>
              <button
            ...
            {message && (
              <p className="mt-4 rounded-xl bg-sky-50 px-4 py-3 text-sm text-[#2F9FE9]">{message}</p>
            )}
          </section>
