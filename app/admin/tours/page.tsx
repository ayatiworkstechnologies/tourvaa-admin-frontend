    ...
    <ModuleWrapper title="Tours" requiredPermission="tours.view">
      <div className="space-y-5">
        <section className="flex flex-col gap-4 rounded-xl border border-[#E7EAF0] bg-white p-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          {hasPermission("tours.create") && <Link href="/admin/tours/create" className="inline-flex items-center gap-2 rounded-xl bg-[#43A9F6] px-4 py-2.5 text-sm font-bold text-white hover:bg-[#2F9FE9]"><Plus size={16} /> Add Tour</Link>}
        </section>
        <DataTable
          ariaLabel="Tours"
          columns={columns}
