      ...
      render: (invoice) =>
        invoice.pdf_path ? (
          <a
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-[#E7EAF0] bg-white px-3 py-1.5 text-xs font-bold text-[#344054] hover:bg-[#F3F8FC] transition-all"
          >
            Download PDF
          </a>
        ) : (
          <span className="text-xs text-[#98A2B3]">Not generated</span>
        ),
    },
  ];
