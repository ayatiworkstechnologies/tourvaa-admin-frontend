    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-[#121826]">Tour Calendar</h2>
        ...
        {entries.length === 0 && !editing && (
          <div className="rounded-xl border border-dashed border-[#E7EAF0] p-8 text-center text-sm text-[#98A2B3]">No calendar entries yet.</div>
        )}
        ...
        {editing && (
          <form onSubmit={saveEntry} className="mt-4 rounded-xl border-2 border-[#43A9F6] bg-white p-6">
      ...
      <div className="rounded-xl border border-[#E7EAF0] bg-white p-6">
        <h3 className="mb-4 font-bold text-[#121826]">Blocked / Unavailable Dates</h3>
        ...
        {blocked.length === 0 ? (
          <p className="text-sm text-[#98A2B3]">No blocked dates.</p>
        ) : (
