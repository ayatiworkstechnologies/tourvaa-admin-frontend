        ...
        <div className="space-y-4">
          <label className="block">
            ...
            <input
              ...
              className="w-full rounded-xl border border-[#E7EAF0] px-4 py-2.5 text-sm outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition-all"
              required
          ...
          <label className="block">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-[#E7EAF0] px-4 py-2.5 pr-11 text-sm outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition-all"
                required
