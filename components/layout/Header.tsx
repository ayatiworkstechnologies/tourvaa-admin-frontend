      ...
      <div className="flex h-[70px] items-center justify-between px-6 md:px-9">
        ...
        <div className="flex min-w-0 items-center gap-3">
          <button
            type="button"
            onClick={onMenuClick}
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[#E8ECF3] bg-white text-[#64748B] shadow-sm hover:bg-[#F5F7FA] lg:hidden"
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-3 rounded-2xl border bg-white py-1.5 pl-1.5 pr-3 transition-all duration-200 hover:shadow-md ${
                open ? "border-[#43A9F6]/50 shadow-md ring-2 ring-[#43A9F6]/15" : "border-[#E8ECF3] shadow-sm hover:border-[#C5D2DF]"
              }`}
            >
                  ...
                  <div className="p-1.5">
                    {canProfile && (
                      <button
                        ...
                        className="flex w-full items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm text-[#334155] hover:bg-[#F5F7FA]"
                      >
